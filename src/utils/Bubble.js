  ...
  rerender(radius) {
    ...
    if (fingerprint !== this.lastFingerprint) {
      ...
      if (isLarge) {
        ...
        const symbolSize = roundedRadius * (this.currency.symbol.length < 5 ? 0.55 : 0.35);
        this.canvas.fillText(this.currency.symbol, roundedRadius, 1.25 * roundedRadius, symbolSize);
